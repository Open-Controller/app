...
var icons = hashMapOf(
        ...
        Icon.CHANNEL_UP to Icons.Outlined.KeyboardArrowUp,
        Icon.CHANNEL_DOWN to Icons.Outlined.KeyboardArrowDown,
        Icon.CHANNEL to Icons.Outlined.Copyright,
        Icon.REMOVE to Icons.Outlined.Delete,
        Icon.STOP to Icons.Outlined.StopCircle,
        Icon.SKIP_FORWARD to Icons.Outlined.ArrowRight,
        Icon.SKIP_REVERSE to Icons.Outlined.ArrowLeft,
        Icon.RECORD to Icons.Outlined.FiberManualRecord,
