        ...
        val house = House.newBuilder()
                    ...
                    .addRoom(Room.newBuilder()
                        ...
                        .addController(Controller.newBuilder()
                            .setName("test")
                            .addWidget(Widget.newBuilder().setArrowLayout(ArrowLayout.newBuilder()
                                    .setTop(Widget.newBuilder().setButton(Button.newBuilder()
                                            .setText("text")
                                            .setIcon("icon")
                                            .setAction(ActionRef.newBuilder().setDevice("Test").setAction("macro"))
                                    ))
                                    .setLeft(Widget.newBuilder().setButton(Button.newBuilder()
                                            .setText("text")
                                            .setIcon("icon")
                                            .setAction(ActionRef.newBuilder().setDevice("Test").setAction("macro"))
                                    ))
                                    .setRight(Widget.newBuilder().setButton(Button.newBuilder()
                                            .setText("text")
                                            .setIcon("icon")
                                            .setAction(ActionRef.newBuilder().setDevice("Test").setAction("macro"))
                                    ))
                                    .setCenter(Widget.newBuilder().setButton(Button.newBuilder()
                                            .setText("text")
                                            .setIcon("icon")
                                            .setAction(ActionRef.newBuilder().setDevice("Test").setAction("macro"))
                                    ))
                                    .setBottom(Widget.newBuilder().setDynamicText(DynamicText.newBuilder()
